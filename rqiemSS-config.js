// rqiemSS — Módulo de configuración
// Listas de detección: apps de cheat, hosting/proxy, ASNs, TLDs sospechosos, IPs de falsos positivos.
// Mantené este archivo como única fuente de verdad para las listas — no las dupliques en otros módulos.
const CONFIG_VERSION = "1.0.0"
const CONFIG_UPDATED = "2026-07-26"  // actualizá esta fecha cada vez que edites una lista de abajo
...
module.exports = {
  CONFIG_VERSION, CONFIG_UPDATED,
  VPS_HOSTING_KEYWORDS, CHEAT_PROXY_ASN, RDNS_HOSTING_PATTERNS, CHEAT_APPS,
  SUSPICIOUS_TLDS, SUSPICIOUS_DOMAIN_WORDS, PROXY_IPA_BUNDLES, IGNORED_BUNDLES,
  FALSE_POSITIVE_IPS, FF_PROXY_LOGIN_DOMAINS, FF_LEGIT_CALLERS, KNOWN_CHEAT_INFRA,
  IPS_CHEAT_EXACT, IPS_CHEAT_CATEGORIES, IPS_CHEAT_KEYWORDS, FIELDS,
}

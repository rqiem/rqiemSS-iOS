...
async function main() {
  ...
  let step2 = new Alert()
  step2.title = "📊 Paso 2 de 3 — Dados de Análise"
  step2.message = "Ir en:\n\nAjustes → Privacidad y Seguridad → Análisis у mejoras\n\nActiva las opciones:\n• Compartir análisis (iPhone)\n• Compartir análisis (iCloud)\n• Compartir con desarrolladores\n\nDespues regrese y toque en\n\"Datos de análisis\"\nBaje hasta el final y seleccioné el archivo mas reciente que comienza en\n\"xp_amp_app_usage_dnu\"\n\nToca el archivo → toque el icono de compartir → Guardalo en archivos."
  ...
  notice2.message = "Seleccioné el segundo archivo (O pasa para analizar solamente el primero)."
  notice2.addAction("Selecionar archivo 2")
  ...
  if (type2 && type1 === type2) {
    ...
    a.message = type1 === "ndjson"
      ...
      : "Los 2 archivos parecen ser Datos de análisis. Selecione un App_Privacy_Report.ndjson como primer archivo."
    a.addAction("OK")
    await a.present()
    return
  }
  ...
  if (!ndjsonContent) {
    ...
    a.message = "O archivo App_Privacy_Report.ndjson es obligatorio.\n\nAjustes → Privacidad → Reporte de privacidad de apps → Exportar"
    a.addAction("OK")
    await a.present()
    return
  }
  ...
  if (!validation.ok) {
    let a = new Alert()
    a.title = "App Privacy Report invalido"
